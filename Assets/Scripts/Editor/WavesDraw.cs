...
/// <summary>
/// Hace que cada elemento de una lista de Wave se muestre en el Inspector
/// como "Wave 1", etc. en vez del "Element 1" genérico de Unity.
/// </summary>
[CustomPropertyDrawer(typeof(Wave))]
public class WaveDraw : PropertyDrawer
{
